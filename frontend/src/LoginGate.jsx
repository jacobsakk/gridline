  ...
  return (
    ...
    >
      <div style={{ width: 560, maxWidth: "100%", textAlign: "center" }}>
        ...
        <div style={{ display: "inline-block", maxWidth: "100%", marginBottom: 26 }}>
          <h1 className="oswald" style={{ fontSize: "clamp(18px, 5.6vw, 30px)", fontWeight: 700, margin: "0 0 8px", letterSpacing: "0.01em", whiteSpace: "nowrap" }}>Central Michigan Recruiting Hub</h1>
          <div style={{ height: 3, width: "100%", background: "linear-gradient(90deg, var(--gold), var(--maroon))", borderRadius: 2 }} />
        </div>
